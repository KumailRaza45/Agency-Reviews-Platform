...
import { Employees, Retainer, getAbbreviatedLocationUsingGeocoder } from '../../Utilities/utilities';
...
const EditCompanyDetails = ({
  ...
  const setEmployees = (item: any) => {
    ...
    setEmployee(false);
    handleFormDataChange('numEmployees', item);
  };
  ...
  const getRetainerText = (text: any) => {
    ...
    setRetainer(false);
    handleFormDataChange('typicalRetainerSize', text);
  };
    ...
    return new Promise<void>((resolve, reject) => {
      ...
      image.onload = () => {
        ...
        if (image.width <= maxWidth && image.height <= maxHeight) {
          ...
          setShowToastForImageUrl(
            true
          );
          setErrorForImageUrl(`Image dimensions must be less than or equal to 800px x 800px`)
  ...
  useEffect(() => {
    ...
    const array = salesEmail ? salesEmail?.split(',') : [];

    setRegularEmail(array)

  }, [showToastForImageUrl, regularEmail]);
        ...
        <div className="grid grid-cols-12 gap-x-10">
          <div className="col-span-12 md:col-span-6">
            ...
            <div className="w-[300px] md:w-full mx-auto mt-5">
              ...
              >
                {numEmployees ? numEmployees?.name : employeesdropdown}
                <svg
                  sidebar-toggle-item
            ...
            <div className="w-[300px] md:w-full mx-auto ">
              ...
              <div className="flex items-center justify-flex-start" style={{ position: "relative" }}>
                ...
                <label
                  role='button'
                  htmlFor='imageslist'
                  className={logo_url ? 'h-[130px] w-[200px]  border-[#D0D5DD] rounded-[8px] pt-4 flex justify-flex-start' : "h-[130px] w-full border border-[#D0D5DD] rounded-[8px] pt-4 flex justify-center"}
                >
                  {isImageUploading ? (
                    <div
                    ...
                    <>
                      {logo_url ? <div className='flex justify-flex-start' style={{ position: "relative" }}>
                        {(logo_url && !isImageUploading) && <RemoveIcon style={{ cursor: "pointer", position: "absolute", zIndex: "5", width: "25px", height: "25px", right: "-5px", top: "-10px", border: "1px solid #D0D5DD", borderRadius: "50%" }}
                          onClick={() => {
