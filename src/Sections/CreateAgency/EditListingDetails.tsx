...
const EditListingDetails: React.FC<Section3Props> = ({
	formData,
	handleSelectedItems,
}) => {
	const { selectedServices, selectedIndustries, selectedMinorities } = formData;

	console.log(selectedIndustries, selectedMinorities, 'minoritiess123');
	...
	return (
		<>
			<div className='mx-[5%] xl:mx-auto max-w-[1400px] mt-10'>
